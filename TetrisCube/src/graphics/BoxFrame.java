...
public class BoxFrame {
	...
	static final FloatBuffer color_data = FloatBuffer.wrap(colors(vertex_data));
	...
	public BoxFrame(GL3 gl, ShaderState st) {
		this.gl = gl;
		this.st = st;
	...
	public void draw() {
		...
		gl.glDrawElements(GL3.GL_LINES, index_data.capacity(), GL3.GL_UNSIGNED_INT, 0);
		
		gl.glDisableVertexAttribArray(vertexPositionID);
		gl.glDisableVertexAttribArray(vertexColorID);
	}
	
	public static float[] colors(FloatBuffer vertex_data) {
